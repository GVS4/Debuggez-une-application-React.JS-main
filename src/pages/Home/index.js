...
const Page = () => {
  ...
  const lastPerformance = data?.events.sort( // Ajout  
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="ServicesContainer" id="nos-services"> {/* Ajout */}
          ...
          <div className="ListContainer">
            ...
            <ServiceCard imageSrc="/images/hall-expo.png">
              <h3>Conférences</h3>
              77events vous propose d’organiser votre évènement, quelle que
        ...
        <section className="PeoplesContainer">
          <h2 className="Title" id="notre-equipe"> {/* Ajout */}
            Notre équipe
          </h2>
